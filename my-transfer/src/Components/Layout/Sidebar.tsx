                ...
                {menuItems.map((item) => {
                    return (
                        ...
                        transition-all duration-200 ${currentPage === item.id || item.active ?
                            ...
                            >
                                <div className="flex items-center space-x-3">
                                    <item.icon className={`w-5 h-5 ${currentPage === item.id || item.active ? "text-white" : "text-slate-500 dark:text-white"}`} />
                                    {!collapsed && (
                                        <>
                                            <span className={`font-medium ml-2 ${currentPage === item.id || item.active ? "text-white" : "text-slate-500 dark:text-white"}`} >
                                                {item.label}
                                            </span>
                                            {item.badge && (
