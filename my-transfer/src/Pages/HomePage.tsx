        ...
        <div className="p-10 bg-transparent min-h-screen">
            ...
            <div className="grid grid-cols-1 sm:grid-cols-2 md:grid-cols-3 gap-10">
                {countries.map(country => (
                    <div
                        key={country.id}
                        className="bg-white/80 dark:bg-slate-900/80 rounded-2xl shadow-xl overflow-hidden transform transition duration-500 hover:scale-105 hover:shadow-xl
                    ...
                    >
                        ...
                        <div className="p-6 text-center">
                            <p className="text-sm text-gray-600 dark:text-slate-400 mb-1">
                                Код: <span className="font-semibold">{country.code}</span>
                            </p>
                            <p className="text-sm text-gray-600 dark:text-slate-400 mb-4">
                                Slug: <span className="font-semibold">{country.slug}</span>
                            </p>
                            {user!=null && user.roles == "Admin" && (
                                <>
                                    <button
                                    ...
                                    <button
                                        ...
                                        onClick={() =>{
                                            ...
                                            navigate(`${basePath}/edit-country/${country.id}`);
                                        }}
